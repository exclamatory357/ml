...
if (isset($_GET["weather"])) {
    ...
    // Build the API URL
    $api_url = "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/weatherdata/forecast?aggregateHours=24&combinationMethod=aggregate&contentType=csv&unitGroup=metric&locationMode=single&key=TJGXYEV6GQSNC8BELQNZG8NCG&dataElements=default&locations=Bantayan%20Island";
