...
if (isset($_POST['email'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        try {
            ...
            $mail->Body    = "Hi, click the link below to reset your password:<br><br><a href='https://danrosefishing.com/home/function/reset_password.php?email=" . urlencode($email) . "'>Reset Password</a>";
